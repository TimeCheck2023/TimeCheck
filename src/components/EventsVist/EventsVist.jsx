  ...
  return (
    <div className='w-full h-full flex items-center flex-col gap-12'>
      ...
      <div className='w-full flex justify-center'>
        ...
        <input type="text" className='bg-slate-300 py-2 focus:outline-none focus:border focus:border-gray-400 rounded-r-md w-1/4 text-zinc-500 text-base px-4' placeholder='Busca un evento'/>
      ...
      <div className='absolute rounded-full bg-slate-200 p-5 text-2xl text-purple-600 bottom-44 right-10 transform transition-transform hover:scale-125 hover:bg-slate-300'>
        <ImPlus/>
      </div>
