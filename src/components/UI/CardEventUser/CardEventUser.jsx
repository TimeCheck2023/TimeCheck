  ...
  return (
    <div className='w-4/5 h-full border border-slate-300 rounded-lg '>
      ...
      <div className='p-3 flex justify-center'>
        <img src="https://images.unsplash.com/photo-1517649763962-0c623066013b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" alt="imagen" className='rounded-md w-64 h-40 object-cover' />
      </div>
      <div className='px-3 py-3'>
        <p className='text-sm text-purple-600 font-bold'>Carrera Via la tebaida</p>
        <p className='text-xs'>
      ...
      <div className='flex flex-row justify-between px-8 py-4'>
        ...
        <button className='flex flex-row items-center border px-4 border-slate-300 rounded-md hover:bg-purple-600 hover:text-white text-purple-600 p-1 gap-1 font-semibold'>
            <p>Ver más</p>
        </button>
      </div>
    </div>
