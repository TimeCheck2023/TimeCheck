    ...
    <div className="w-full h-screen flex flex-row">
      ...
      <div className="w-full lg:w-1/2 h-full ">
        ...
        <div className="mt-10 lg:mt-20 w-full flex flex-col justify-center items-center">
          <div className="flex lg:my-10 lg:mx-32 relative justify-center items-center lg:left-20 w-5/6 sm:w-full 2xl:w-5/6">
          ...
          <div className="relative mt-5 text-center left-16 lg:mt-0 lg:left-1/2 w-60 2xl:left-72">
          ...
          <div className="footer my-10 mx-20 flex flex-col justify-center items-center ">
            <div className="flex gap-2 lg:gap-28 xl:gap-16 flex-col md:flex-row">
              <button type="submit" className=" p-4 w-56 h-14 bg-purple-700 hover:bg-purple-900 rounded-lg text-white font-bold">
                Iniciar Sesion
              </button>
